...
function NavHeader() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "NavHeader.useEffect": ()=>{
            if (!menuOpen) return;
            const onKey = {
                "NavHeader.useEffect.onKey": (e)=>{
                    if (e.key === 'Escape') setMenuOpen(false);
                }
            }["NavHeader.useEffect.onKey"];
            document.addEventListener('keydown', onKey);
            return ({
                "NavHeader.useEffect": ()=>document.removeEventListener('keydown', onKey)
            })["NavHeader.useEffect"];
        }
    }["NavHeader.useEffect"], [
        menuOpen
...
__turbopack_context__.k.register(_c3, "NavHeader");
...
//# sourceMappingURL=components_NavHeader_tsx_0ip2dbq._.js.map